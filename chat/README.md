...
└── 📁 groups/                # Logica verticale e interfacce dei gruppi
    ├── groups-ui.js           # Gestione elementi DOM base e lista selezione membri
    ├── groups-create.js       # Modal e logica di creazione nuovo gruppo
    ├── groups-info.js         # Modal "Info Gruppo" e rendering partecipanti
    ├── groups-management.js   # Modifica nome, avatar, aggiunta ed espulsione membri
    └── groups-actions.js      # Abbandono gruppo e reset dell'interfaccia chat
