...
// MODIFICA: Ora tracciamo oggetti completi {uid, username} per poter scrivere le regole e il dizionario nomi
...
function renderSelectedMembers() {
    ...
    selectedGroupMembers.forEach(memberObj => {
        ...
        div.innerHTML = `${memberObj.username} <span class="ml-1 font-bold">×</span>`;
        div.onclick = () => {
            selectedGroupMembers = selectedGroupMembers.filter(m => m.uid !== memberObj.uid);
