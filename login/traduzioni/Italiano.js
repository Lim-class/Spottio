const it_translations = {
    ...
    loginUsernamePlaceholder: 'Inserisci la tua mail',
    ...
    labelPrivacy: 'Accetto <a href="login/footer/Privacy.html" class="text-blue-600 hover:underline">Privacy</a> e <a href="login/footer/Policy.html" class="text-blue-600 hover:underline">Policy</a>'
};