...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var updateContent = function updateContent(lang) {
  ...
  var languageDropdownMenu = document.getElementById('language-dropdown-menu');
  var dropdownIcon = document.getElementById('dropdown-icon');
  var selectedFlag = document.getElementById('selected-flag');
  var selectedLangText = document.getElementById('selected-lang-text');
  var langOptions = document.querySelectorAll('.lang-option'); // Listener per il click sul pulsante di toggle
  ...
  langOptions.forEach(function (option) {
    option.addEventListener('click', function () {
      ...
      var flagSrc = option.querySelector('img').src; // Aggiorna la bandiera e il testo

      selectedFlag.src = flagSrc;
      selectedFlag.alt = "Bandiera ".concat(text);
      selectedLangText.textContent = text; // Chiudi il menu a tendina

      languageDropdownMenu.classList.add('hidden');
      dropdownIcon.classList.remove('rotate-180'); // Chiama la funzione di traduzione
