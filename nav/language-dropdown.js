document.addEventListener('DOMContentLoaded', () => {
    ...
    window.translations = {
        'it': {
            menuTitle: 'Menu', navPubblici: 'Spot', navCercaPersone: 'Trova', navMessaggi: 'Messaggi', navPosta: 'Posta', navSegnalazioni: 'Segnalazioni', navProfilo: 'Profilo', navImpostazioni: 'Impostazioni', navAdmin: 'Gestione Utenti', logout: 'Esci',
